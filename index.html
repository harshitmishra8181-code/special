...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body {
      background: linear-gradient(to top right, #ffc9de, #ffd1dc);
      overflow: hidden;
    ...
    .question {
      ...
      opacity: 0;
      transform: scale(0.8);
      animation: showQuestion 2s forwards;
      padding: 30px;
      max-width: 90%;
    }
    ...
    @keyframes floatUp {
      ...
      100% {
        top: -10%;
        transform: translateX(0) translateY(-100vh) rotate(360deg) scale(1.2);
        opacity: 0;
      }
    }
    ...
    .sticker {
      ...
      height: 250px;
      margin-top: 20px;
      animation: popSticker 2s ease forwards;
      opacity: 0;
      object-fit: contain;
    }
    ...
    button {
      ...
      font-size: 1.2rem;
      cursor: pointer;
      box-shadow: 2px 2px 10px #ff8fa3;
...
<body>
  ...
  <div id="content">
    ...
    <div class="final hidden" id="final">Happy New Year Varnika💗-Harshit️</div>
    <button id="nextBtn">Next</button>
  </div>

<script>
  const questions = [
    "Hey you shawtyy🌸             ( ohh forgot I can't call you that now)",
    "Do you like different surprises?",
    "Would you like something new? 🧸",
    "Dreaming of a wish? ✨",
    "Get ready for New Year‼️"
  ];
